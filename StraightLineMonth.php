...
<div class="container bg-dark text-white">
    ...
    ?>
    <center>
    <h2><strong>Straight Line Depreciation : Depreciation per Month </strong></h2>
    <div class="rows">
        <form action="StraightLineMonth.php" method="get">
        ...
        <?php
            if (isset($_GET['cost'])) {
                ...
                echo "<h1><strong>Depreciation per Month : <br>$result</strong></h1>";
            }
        ?>
    </div>
    <h2><strong><a href="StraightLineAnnum.php">Depreciation per Annum ?</a></strong></h2>
</div>
<center>
</center>
</html>